...
public class MainForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        gepValasztasa = new javax.swing.JLabel();
        ...
        gepValasztasa.setText("gép választása:");
        ...
        jRadioButtonMenuItem2.setText("Előzö");
        jMenu2.add(jRadioButtonMenuItem2);

        buttonGroup1.add(jRadioButtonMenuItem3);
        jRadioButtonMenuItem3.setText("Betölt");
    ...
    private void btnInditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInditActionPerformed
        String JatekosValasztas=buttonGroup2.getSelection().getActionCommand();
        korInditMegallit(false);
                String[] sorozat = {"Kő","Papir","ollo"};
        String[] sorozat1 = {"Kő","Papir","ollo"};
        int rand = new Random().nextInt(3);
        gepValasztasa.setText("gép választása:"+sorozat[rand]);
        if(sorozat[rand]=="Kő"){
            kornyertes.setText("kör nyertese: NINCS");
        }else{
            if(sorozat[rand]=="Kő" && JatekosValasztas=="Papír" || sorozat[rand]=="Papír" && JatekosValasztas=="Ollo" || sorozat[rand]=="Ollo" && JatekosValasztas=="Kő"){
                kornyertes.setText("kör nyertese: Játékos");
            }else{
                kornyertes.setText("kör nyertese: Gép");
            }
        }
    ...
    private void valasztas(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_valasztas
        //esemeny kulon elnevezes 2 gomb is hasznalhatja
...
public void korInditMegallit(boolean seged){
    btnIndit.setEnabled(seged);
}
public void getvalasztas(){
}
    ...
    private javax.swing.JLabel gepValasztasa;
